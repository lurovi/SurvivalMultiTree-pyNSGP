...
nsgp = NSGP(pop_size=100, max_generations=10, verbose=True, max_tree_size=50, 
	crossover_rate=0.8, mutation_rate=0.1, op_mutation_rate=0.1, min_depth=2, initialization_max_tree_height=6, 
	tournament_size=4, use_linear_scaling=True, use_erc=True, use_interpretability_model=True,
